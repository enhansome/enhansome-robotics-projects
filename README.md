...
* [LeRobot](https://github.com/huggingface/lerobot/tree/main) ⭐ 27,428 | 🐛 867 | 🌐 Python | 📅 2026-09-12 - State-of-the-art AI for real-world robotics
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,636 | 🐛 14 | 🌐 HTML | 📅 2026-09-03 - Open-source 6-wheel rover based on the rovers on Mars
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 4,053 | 🐛 29 | 🌐 Python | 📅 2026-01-31 - Making a mini version of the BDX droid. <https://discord.gg/UtJZsgfQGe>
...
* [copper-project/copper-rs](https://github.com/copper-project/copper-rs) ⭐ 1,488 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 - Robot SDK in Rust (deterministic and high performance)
* [unitreerobotics/unitree\_sdk2](https://github.com/unitreerobotics/unitree_sdk2) ⭐ 1,353 | 🐛 14 | 🌐 C++ | 📅 2026-08-20 - Unitree robot sdk version 2
...
* [commaai/openpilot](https://github.com/commaai/openpilot) ⭐ 63,638 | 🐛 153 | 🌐 Python | 📅 2026-09-12 - openpilot is an open source driver assistance system.
* [ApolloAuto/apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,825 | 🐛 1,047 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform
* [autowarefoundation/autoware.universe](https://github.com/autowarefoundation/autoware.universe) ⭐ 1,752 | 🐛 496 | 🌐 C++ | 📅 2026-09-12 - Open-source software for self-driving vehicles

### ML & Vision

* [openMVG/openMVG](https://github.com/openMVG/openMVG/) ⭐ 6,557 | 🐛 311 | 🌐 C++ | 📅 2026-08-30 - open Multiple View Geometry library. Basis for 3D computer vision and Structure from Motion.
* [borglab/gtsam](https://github.com/borglab/gtsam) ⭐ 3,679 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-09-12 - Georgia Tech Smoothing and Mapping Library
...
* [CRISP](https://github.com/mjyc/awesome-robotics-projects) ⭐ 1,764 | 🐛 10 | 📅 2026-02-13 - Compliant ROS2 Controllers for Learning-Based Manipulation Policies
* [any4lerobot](https://github.com/Tavish9/any4lerobot) ⭐ 1,150 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - A collection of utilities and tools for LeRobot
...
* [ROSA](https://github.com/nasa-jpl/rosa) ⭐ 1,629 | 🐛 4 | 🌐 Python | 📅 2026-03-17 - The ROS Agent
...
* [web-based visualization libraries](https://github.com/cruise-automation/webviz) ⭐ 2,339 | 🐛 134 | 🌐 JavaScript | 📅 2022-12-17
* [Lanelet2](https://github.com/fzi-forschungszentrum-informatik/lanelet2) ⭐ 963 | 🐛 18 | 🌐 C++ | 📅 2026-06-18 - C++ library for handling map data in the context of automated driving
* [URDF-Architect](https://github.com/OpenLegged/URDF-Architect) ⭐ 474 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-09 - URDF-Architect is a web-based visual URDF robot modeler with 3D workspace, structured skeleton/detail/hardware workflows, motor library integration, MuJoCo export, and AI assistance.
...
* [phntm\_bridge\_client](https://github.com/PhantomCybernetics/phntm_bridge_client) ⭐ 73 | 🐛 9 | 🌐 C++ | 📅 2026-09-12 - Fast WebRTC + Socket.io ROS2 Bridge for real-time data and video streaming, teleoperation, HRI, and remote robot monitoring
* [mujoco-scene-editor](https://github.com/markusgrotz/mujoco-scene-editor) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-04-14 - Lightweight, interactive scene editor for MuJoCo scenes
...
* [Open 3D Engine (O3DE)](https://github.com/o3de/o3de) ⭐ 9,675 | 🐛 3,494 | 🌐 C++ | 📅 2026-09-10 - An Apache 2.0-licensed multi-platform 3D engine that enables developers and content creators to build AAA games, cinema-quality 3D worlds, and high-fidelity simulations without any fees or commercial obligations.
...
* [LIBERO](https://github.com/Lifelong-Robot-Learning/LIBERO) ⭐ 2,307 | 🐛 97 | 🌐 Jupyter Notebook | 📅 2025-03-15 - Benchmarking Knowledge Transfer in Lifelong Robot Learning
* [OmniGibson](https://github.com/StanfordVL/OmniGibson) ⭐ 1,689 | 🐛 311 | 🌐 Python | 📅 2026-09-11 - A platform for accelerating Embodied AI research built upon NVIDIA's Omniverse engine
...
* [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 7,042 | 🐛 40 | 📅 2024-09-22 (Kiloreux)
* [Awesome Robotic Tooling](https://github.com/Ly0n/awesome-robotic-tooling) ⭐ 3,891 | 🐛 13 | 📅 2023-11-20
* [Awesome Robotics Libraries](https://github.com/jslee02/awesome-robotics-libraries) ⭐ 3,043 | 🐛 21 | 🌐 Python | 📅 2026-09-06
* [Awesome Robot Operating System 2 (ROS 2)](https://github.com/fkromer/awesome-ros2) ⚠️ Archived
* [Awesome Robotics](https://github.com/ahundt/awesome-robotics) ⭐ 1,487 | 🐛 8 | 📅 2024-01-10 (ahundt)
