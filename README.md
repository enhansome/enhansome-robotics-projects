...
* [LeRobot](https://github.com/huggingface/lerobot/tree/main) ⭐ 27,157 | 🐛 847 | 🌐 Python | 📅 2026-09-02 - State-of-the-art AI for real-world robotics
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,623 | 🐛 17 | 🌐 Prolog | 📅 2026-08-13 - Open-source 6-wheel rover based on the rovers on Mars
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,895 | 🐛 27 | 🌐 Python | 📅 2026-01-31 - Making a mini version of the BDX droid. <https://discord.gg/UtJZsgfQGe>
...
* [copper-project/copper-rs](https://github.com/copper-project/copper-rs) ⭐ 1,478 | 🐛 21 | 🌐 Rust | 📅 2026-09-01 - Robot SDK in Rust (deterministic and high performance)
...
* [commaai/openpilot](https://github.com/commaai/openpilot) ⭐ 63,554 | 🐛 134 | 🌐 Python | 📅 2026-09-02 - openpilot is an open source driver assistance system.
* [ApolloAuto/apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,819 | 🐛 1,046 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform
* [autowarefoundation/autoware.universe](https://github.com/autowarefoundation/autoware.universe) ⭐ 1,746 | 🐛 483 | 🌐 C++ | 📅 2026-09-02 - Open-source software for self-driving vehicles

### ML & Vision

* [openMVG/openMVG](https://github.com/openMVG/openMVG/) ⭐ 6,549 | 🐛 311 | 🌐 C++ | 📅 2026-08-30 - open Multiple View Geometry library. Basis for 3D computer vision and Structure from Motion.
* [borglab/gtsam](https://github.com/borglab/gtsam) ⭐ 3,663 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-09-02 - Georgia Tech Smoothing and Mapping Library
...
* [any4lerobot](https://github.com/Tavish9/any4lerobot) ⭐ 1,146 | 🐛 5 | 🌐 Python | 📅 2026-08-17 - A collection of utilities and tools for LeRobot
...
* [URDF-Architect](https://github.com/OpenLegged/URDF-Architect) ⭐ 468 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 - URDF-Architect is a web-based visual URDF robot modeler with 3D workspace, structured skeleton/detail/hardware workflows, motor library integration, MuJoCo export, and AI assistance.
...
* [Open 3D Engine (O3DE)](https://github.com/o3de/o3de) ⭐ 9,653 | 🐛 3,498 | 🌐 C++ | 📅 2026-09-01 - An Apache 2.0-licensed multi-platform 3D engine that enables developers and content creators to build AAA games, cinema-quality 3D worlds, and high-fidelity simulations without any fees or commercial obligations.
...
* [OmniGibson](https://github.com/StanfordVL/OmniGibson) ⭐ 1,676 | 🐛 309 | 🌐 Python | 📅 2026-09-02 - A platform for accelerating Embodied AI research built upon NVIDIA's Omniverse engine
...
* [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 7,004 | 🐛 38 | 📅 2024-09-22 (Kiloreux)
...
* [Awesome HRI Papers for Industry](https://github.com/mjyc/awesome-robotics-system-design) ⭐ 140 | 🐛 0 | 📅 2025-10-27
* [Awesome Robotics System Design (and more)](https://github.com/mjyc/awesome-robotics-system-design) ⭐ 140 | 🐛 0 | 📅 2025-10-27
* [Awesome HRI Datasets and Human Simulators](https://github.com/mjyc/awesome-hri-datasets) ⭐ 78 | 🐛 0 | 📅 2021-11-13
