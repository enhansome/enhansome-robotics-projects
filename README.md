...
* [LeRobot](https://github.com/huggingface/lerobot/tree/main) ⭐ 27,441 | 🐛 874 | 🌐 Python | 📅 2026-09-13 - State-of-the-art AI for real-world robotics
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,641 | 🐛 14 | 🌐 HTML | 📅 2026-09-03 - Open-source 6-wheel rover based on the rovers on Mars
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 4,061 | 🐛 29 | 🌐 Python | 📅 2026-01-31 - Making a mini version of the BDX droid. <https://discord.gg/UtJZsgfQGe>
...
* [BCN3D](https://github.com/BCN3D/BCN3D-Moveo) ⭐ 1,961 | 🐛 47 | 🌐 C++ | 📅 2022-03-01 - Open Source 3D Printed Robotic Arm for educational purposes
...
* [copper-project/copper-rs](https://github.com/copper-project/copper-rs) ⭐ 1,488 | 🐛 26 | 🌐 Rust | 📅 2026-09-13 - Robot SDK in Rust (deterministic and high performance)
* [unitreerobotics/unitree\_sdk2](https://github.com/unitreerobotics/unitree_sdk2) ⭐ 1,355 | 🐛 14 | 🌐 C++ | 📅 2026-08-20 - Unitree robot sdk version 2
...
* [commaai/openpilot](https://github.com/commaai/openpilot) ⭐ 63,646 | 🐛 137 | 🌐 Python | 📅 2026-09-13 - openpilot is an open source driver assistance system.
* [ApolloAuto/apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,824 | 🐛 1,047 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform
* [autowarefoundation/autoware.universe](https://github.com/autowarefoundation/autoware.universe) ⭐ 1,753 | 🐛 495 | 🌐 C++ | 📅 2026-09-13 - Open-source software for self-driving vehicles
...
* [borglab/gtsam](https://github.com/borglab/gtsam) ⭐ 3,680 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2026-09-12 - Georgia Tech Smoothing and Mapping Library
...
* [KFCore](https://github.com/jnz/KFCore) ⭐ 186 | 🐛 0 | 🌐 C | 📅 2026-07-29 - A lightweight, high-performance Kalman Filter library in C, C++, and MATLAB

## Command Line Tools

* [ROSA](https://github.com/nasa-jpl/rosa) ⭐ 1,628 | 🐛 4 | 🌐 Python | 📅 2026-03-17 - The ROS Agent
...
* [URDF-Architect](https://github.com/OpenLegged/URDF-Architect) ⭐ 474 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-13 - URDF-Architect is a web-based visual URDF robot modeler with 3D workspace, structured skeleton/detail/hardware workflows, motor library integration, MuJoCo export, and AI assistance.
...
* [Open 3D Engine (O3DE)](https://github.com/o3de/o3de) ⭐ 9,678 | 🐛 3,494 | 🌐 C++ | 📅 2026-09-10 - An Apache 2.0-licensed multi-platform 3D engine that enables developers and content creators to build AAA games, cinema-quality 3D worlds, and high-fidelity simulations without any fees or commercial obligations.
...
* [LIBERO](https://github.com/Lifelong-Robot-Learning/LIBERO) ⭐ 2,308 | 🐛 98 | 🌐 Jupyter Notebook | 📅 2025-03-15 - Benchmarking Knowledge Transfer in Lifelong Robot Learning
* [OmniGibson](https://github.com/StanfordVL/OmniGibson) ⭐ 1,691 | 🐛 311 | 🌐 Python | 📅 2026-09-11 - A platform for accelerating Embodied AI research built upon NVIDIA's Omniverse engine
...
* [SimplerEnv](https://github.com/simpler-env/SimplerEnv) ⭐ 1,162 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2025-12-20 - Simulated Manipulation Policy Evaluation Environments for Real Robot Setups
...
* [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 7,046 | 🐛 40 | 📅 2024-09-22 (Kiloreux)
