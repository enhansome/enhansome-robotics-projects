...
* [LeRobot](https://github.com/huggingface/lerobot/tree/main) ⭐ 26,906 | 🐛 822 | 🌐 Python | 📅 2026-08-25 - State-of-the-art AI for real-world robotics
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,603 | 🐛 16 | 🌐 Prolog | 📅 2026-08-13 - Open-source 6-wheel rover based on the rovers on Mars
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,515 | 🐛 25 | 🌐 Python | 📅 2026-01-31 - Making a mini version of the BDX droid. <https://discord.gg/UtJZsgfQGe>
* [Stanford Doggo](https://github.com/Nate711/StanfordDoggoProject) ⭐ 2,549 | 🐛 11 | 📅 2024-07-08 - Open-source quadruped robot
* [CHAMP](https://github.com/chvmp/champ) ⭐ 2,304 | 🐛 55 | 🌐 C++ | 📅 2024-07-04 - 𓃡 CHAMP Quadruped Controller ROS Package
...
* [copper-project/copper-rs](https://github.com/copper-project/copper-rs) ⭐ 1,463 | 🐛 31 | 🌐 Rust | 📅 2026-08-24 - Robot SDK in Rust (deterministic and high performance)
* [unitreerobotics/unitree\_sdk2](https://github.com/unitreerobotics/unitree_sdk2) ⭐ 1,316 | 🐛 14 | 🌐 C++ | 📅 2026-08-20 - Unitree robot sdk version 2
...
* [robotemi/sdk](https://github.com/robotemi/sdk) ⭐ 252 | 🐛 145 | 🌐 Kotlin | 📅 2026-08-24 - temi SDK
* [resibots/minitaur\_sdk](https://github.com/resibots/minitaur_sdk) ⭐ 9 | 🐛 0 | 🌐 C++ | 📅 2019-04-12 - Minitaur SDK extension

### Autonomous Driving

* [commaai/openpilot](https://github.com/commaai/openpilot) ⭐ 63,489 | 🐛 132 | 🌐 Python | 📅 2026-08-25 - openpilot is an open source driver assistance system.
* [ApolloAuto/apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,804 | 🐛 1,045 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform
* [autowarefoundation/autoware.universe](https://github.com/autowarefoundation/autoware.universe) ⭐ 1,737 | 🐛 490 | 🌐 C++ | 📅 2026-08-25 - Open-source software for self-driving vehicles
...
* [borglab/gtsam](https://github.com/borglab/gtsam) ⭐ 3,652 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-08-25 - Georgia Tech Smoothing and Mapping Library
* [facebookresearch/theseus](https://github.com/facebookresearch/theseus) ⭐ 2,054 | 🐛 83 | 🌐 Python | 📅 2025-01-16 - A library for differentiable nonlinear optimization
...
* [any4lerobot](https://github.com/Tavish9/any4lerobot) ⭐ 1,139 | 🐛 4 | 🌐 Python | 📅 2026-08-17 - A collection of utilities and tools for LeRobot
...
* [Lanelet2](https://github.com/fzi-forschungszentrum-informatik/lanelet2) ⭐ 958 | 🐛 19 | 🌐 C++ | 📅 2026-06-18 - C++ library for handling map data in the context of automated driving
* [URDF-Architect](https://github.com/OpenLegged/URDF-Architect) ⭐ 462 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-25 - URDF-Architect is a web-based visual URDF robot modeler with 3D workspace, structured skeleton/detail/hardware workflows, motor library integration, MuJoCo export, and AI assistance.
...
* [Open 3D Engine (O3DE)](https://github.com/o3de/o3de) ⭐ 9,627 | 🐛 3,491 | 🌐 C++ | 📅 2026-08-25 - An Apache 2.0-licensed multi-platform 3D engine that enables developers and content creators to build AAA games, cinema-quality 3D worlds, and high-fidelity simulations without any fees or commercial obligations.
* [Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,565 | 🐛 57 | 🌐 C# | 📅 2024-11-26 - Central repository for tools, tutorials, resources, and documentation for robotics simulation in Unity
* [LIBERO](https://github.com/Lifelong-Robot-Learning/LIBERO) ⭐ 2,235 | 🐛 98 | 🌐 Jupyter Notebook | 📅 2025-03-15 - Benchmarking Knowledge Transfer in Lifelong Robot Learning
* [OmniGibson](https://github.com/StanfordVL/OmniGibson) ⭐ 1,657 | 🐛 309 | 🌐 Python | 📅 2026-08-24 - A platform for accelerating Embodied AI research built upon NVIDIA's Omniverse engine
...
* [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 6,980 | 🐛 37 | 📅 2024-09-22 (Kiloreux)
