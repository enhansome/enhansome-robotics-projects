...
* [LeRobot](https://github.com/huggingface/lerobot/tree/main) ⭐ 27,210 | 🐛 858 | 🌐 Python | 📅 2026-09-04 - State-of-the-art AI for real-world robotics
...
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,950 | 🐛 28 | 🌐 Python | 📅 2026-01-31 - Making a mini version of the BDX droid. <https://discord.gg/UtJZsgfQGe>
...
* [copper-project/copper-rs](https://github.com/copper-project/copper-rs) ⭐ 1,479 | 🐛 24 | 🌐 Rust | 📅 2026-09-04 - Robot SDK in Rust (deterministic and high performance)
* [unitreerobotics/unitree\_sdk2](https://github.com/unitreerobotics/unitree_sdk2) ⭐ 1,335 | 🐛 14 | 🌐 C++ | 📅 2026-08-20 - Unitree robot sdk version 2
...
* [commaai/openpilot](https://github.com/commaai/openpilot) ⭐ 63,571 | 🐛 136 | 🌐 Python | 📅 2026-09-04 - openpilot is an open source driver assistance system.
* [ApolloAuto/apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,821 | 🐛 1,047 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform
* [autowarefoundation/autoware.universe](https://github.com/autowarefoundation/autoware.universe) ⭐ 1,745 | 🐛 481 | 🌐 C++ | 📅 2026-09-04 - Open-source software for self-driving vehicles
...
* [borglab/gtsam](https://github.com/borglab/gtsam) ⭐ 3,665 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-09-04 - Georgia Tech Smoothing and Mapping Library
...
* [CRISP](https://github.com/mjyc/awesome-robotics-projects) ⭐ 1,748 | 🐛 10 | 📅 2026-02-13 - Compliant ROS2 Controllers for Learning-Based Manipulation Policies
...
* [Open 3D Engine (O3DE)](https://github.com/o3de/o3de) ⭐ 9,656 | 🐛 3,501 | 🌐 C++ | 📅 2026-09-04 - An Apache 2.0-licensed multi-platform 3D engine that enables developers and content creators to build AAA games, cinema-quality 3D worlds, and high-fidelity simulations without any fees or commercial obligations.
...
* [LIBERO](https://github.com/Lifelong-Robot-Learning/LIBERO) ⭐ 2,272 | 🐛 98 | 🌐 Jupyter Notebook | 📅 2025-03-15 - Benchmarking Knowledge Transfer in Lifelong Robot Learning
* [OmniGibson](https://github.com/StanfordVL/OmniGibson) ⭐ 1,681 | 🐛 309 | 🌐 Python | 📅 2026-09-02 - A platform for accelerating Embodied AI research built upon NVIDIA's Omniverse engine
...
* [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 7,007 | 🐛 40 | 📅 2024-09-22 (Kiloreux)
...
* [Awesome Weekly Robotics](https://github.com/msadowski/awesome-weekly-robotics) ⭐ 1,066 | 🐛 6 | 📅 2026-05-31
