...
* [LeRobot](https://github.com/huggingface/lerobot/tree/main) ⭐ 26,930 | 🐛 826 | 🌐 Python | 📅 2026-08-26 - State-of-the-art AI for real-world robotics
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,609 | 🐛 16 | 🌐 Prolog | 📅 2026-08-13 - Open-source 6-wheel rover based on the rovers on Mars
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,518 | 🐛 25 | 🌐 Python | 📅 2026-01-31 - Making a mini version of the BDX droid. <https://discord.gg/UtJZsgfQGe>
* [Stanford Doggo](https://github.com/Nate711/StanfordDoggoProject) ⭐ 2,550 | 🐛 11 | 📅 2024-07-08 - Open-source quadruped robot
* [CHAMP](https://github.com/chvmp/champ) ⭐ 2,304 | 🐛 55 | 🌐 C++ | 📅 2024-07-04 - 𓃡 CHAMP Quadruped Controller ROS Package
* [BCN3D](https://github.com/BCN3D/BCN3D-Moveo) ⭐ 1,940 | 🐛 47 | 🌐 C++ | 📅 2022-03-01 - Open Source 3D Printed Robotic Arm for educational purposes
...
* [boston-dynamics/spot-sdk](https://github.com/boston-dynamics/spot-sdk) ⭐ 2,499 | 🐛 106 | 🌐 Python | 📅 2026-08-11 - Spot SDK
...
* [copper-project/copper-rs](https://github.com/copper-project/copper-rs) ⭐ 1,466 | 🐛 32 | 🌐 Rust | 📅 2026-08-25 - Robot SDK in Rust (deterministic and high performance)
* [unitreerobotics/unitree\_sdk2](https://github.com/unitreerobotics/unitree_sdk2) ⭐ 1,318 | 🐛 14 | 🌐 C++ | 📅 2026-08-20 - Unitree robot sdk version 2
...
* [commaai/openpilot](https://github.com/commaai/openpilot) ⭐ 63,501 | 🐛 133 | 🌐 Python | 📅 2026-08-26 - openpilot is an open source driver assistance system.
* [ApolloAuto/apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,807 | 🐛 1,045 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform
* [autowarefoundation/autoware.universe](https://github.com/autowarefoundation/autoware.universe) ⭐ 1,737 | 🐛 486 | 🌐 C++ | 📅 2026-08-26 - Open-source software for self-driving vehicles

### ML & Vision

* [openMVG/openMVG](https://github.com/openMVG/openMVG/) ⭐ 6,542 | 🐛 312 | 🌐 C++ | 📅 2025-12-17 - open Multiple View Geometry library. Basis for 3D computer vision and Structure from Motion.
* [borglab/gtsam](https://github.com/borglab/gtsam) ⭐ 3,656 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-08-26 - Georgia Tech Smoothing and Mapping Library
...
* [CRISP](https://github.com/mjyc/awesome-robotics-projects) ⭐ 1,736 | 🐛 7 | 📅 2026-02-13 - Compliant ROS2 Controllers for Learning-Based Manipulation Policies
* [any4lerobot](https://github.com/Tavish9/any4lerobot) ⭐ 1,140 | 🐛 4 | 🌐 Python | 📅 2026-08-17 - A collection of utilities and tools for LeRobot
...
* [web-based visualization libraries](https://github.com/cruise-automation/webviz) ⭐ 2,329 | 🐛 134 | 🌐 JavaScript | 📅 2022-12-17
...
* [URDF-Architect](https://github.com/OpenLegged/URDF-Architect) ⭐ 464 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-25 - URDF-Architect is a web-based visual URDF robot modeler with 3D workspace, structured skeleton/detail/hardware workflows, motor library integration, MuJoCo export, and AI assistance.
...
* [Open 3D Engine (O3DE)](https://github.com/o3de/o3de) ⭐ 9,629 | 🐛 3,489 | 🌐 C++ | 📅 2026-08-25 - An Apache 2.0-licensed multi-platform 3D engine that enables developers and content creators to build AAA games, cinema-quality 3D worlds, and high-fidelity simulations without any fees or commercial obligations.
* [Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,566 | 🐛 57 | 🌐 C# | 📅 2024-11-26 - Central repository for tools, tutorials, resources, and documentation for robotics simulation in Unity
* [LIBERO](https://github.com/Lifelong-Robot-Learning/LIBERO) ⭐ 2,237 | 🐛 98 | 🌐 Jupyter Notebook | 📅 2025-03-15 - Benchmarking Knowledge Transfer in Lifelong Robot Learning
* [OmniGibson](https://github.com/StanfordVL/OmniGibson) ⭐ 1,659 | 🐛 309 | 🌐 Python | 📅 2026-08-26 - A platform for accelerating Embodied AI research built upon NVIDIA's Omniverse engine
...
* [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 6,982 | 🐛 38 | 📅 2024-09-22 (Kiloreux)
...
* [Awesome Robotics](https://github.com/ahundt/awesome-robotics) ⭐ 1,479 | 🐛 8 | 📅 2024-01-10 (ahundt)
...
* [Awesome HRI Papers for Industry](https://github.com/mjyc/awesome-robotics-system-design) ⭐ 138 | 🐛 0 | 📅 2025-10-27
* [Awesome Robotics System Design (and more)](https://github.com/mjyc/awesome-robotics-system-design) ⭐ 138 | 🐛 0 | 📅 2025-10-27
* [Awesome HRI Datasets and Human Simulators](https://github.com/mjyc/awesome-hri-datasets) ⭐ 78 | 🐛 0 | 📅 2021-11-13
