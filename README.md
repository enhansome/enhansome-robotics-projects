...
* [LeRobot](https://github.com/huggingface/lerobot/tree/main) ⭐ 27,414 | 🐛 861 | 🌐 Python | 📅 2026-09-11 - State-of-the-art AI for real-world robotics
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,635 | 🐛 14 | 🌐 HTML | 📅 2026-09-03 - Open-source 6-wheel rover based on the rovers on Mars
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 4,041 | 🐛 29 | 🌐 Python | 📅 2026-01-31 - Making a mini version of the BDX droid. <https://discord.gg/UtJZsgfQGe>
...
* [copper-project/copper-rs](https://github.com/copper-project/copper-rs) ⭐ 1,488 | 🐛 24 | 🌐 Rust | 📅 2026-09-11 - Robot SDK in Rust (deterministic and high performance)
...
* [commaai/openpilot](https://github.com/commaai/openpilot) ⭐ 63,631 | 🐛 144 | 🌐 Python | 📅 2026-09-11 - openpilot is an open source driver assistance system.
* [ApolloAuto/apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,826 | 🐛 1,047 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform
* [autowarefoundation/autoware.universe](https://github.com/autowarefoundation/autoware.universe) ⭐ 1,751 | 🐛 492 | 🌐 C++ | 📅 2026-09-11 - Open-source software for self-driving vehicles

### ML & Vision

* [openMVG/openMVG](https://github.com/openMVG/openMVG/) ⭐ 6,555 | 🐛 311 | 🌐 C++ | 📅 2026-08-30 - open Multiple View Geometry library. Basis for 3D computer vision and Structure from Motion.
* [borglab/gtsam](https://github.com/borglab/gtsam) ⭐ 3,678 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Georgia Tech Smoothing and Mapping Library
...
* [CRISP](https://github.com/mjyc/awesome-robotics-projects) ⭐ 1,763 | 🐛 10 | 📅 2026-02-13 - Compliant ROS2 Controllers for Learning-Based Manipulation Policies
* [any4lerobot](https://github.com/Tavish9/any4lerobot) ⭐ 1,149 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - A collection of utilities and tools for LeRobot
...
* [ROSA](https://github.com/nasa-jpl/rosa) ⭐ 1,627 | 🐛 4 | 🌐 Python | 📅 2026-03-17 - The ROS Agent
...
* [URDF-Architect](https://github.com/OpenLegged/URDF-Architect) ⭐ 473 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-09 - URDF-Architect is a web-based visual URDF robot modeler with 3D workspace, structured skeleton/detail/hardware workflows, motor library integration, MuJoCo export, and AI assistance.
...
* [Open 3D Engine (O3DE)](https://github.com/o3de/o3de) ⭐ 9,673 | 🐛 3,494 | 🌐 C++ | 📅 2026-09-10 - An Apache 2.0-licensed multi-platform 3D engine that enables developers and content creators to build AAA games, cinema-quality 3D worlds, and high-fidelity simulations without any fees or commercial obligations.
...
* [LIBERO](https://github.com/Lifelong-Robot-Learning/LIBERO) ⭐ 2,304 | 🐛 97 | 🌐 Jupyter Notebook | 📅 2025-03-15 - Benchmarking Knowledge Transfer in Lifelong Robot Learning
* [OmniGibson](https://github.com/StanfordVL/OmniGibson) ⭐ 1,690 | 🐛 310 | 🌐 Python | 📅 2026-09-11 - A platform for accelerating Embodied AI research built upon NVIDIA's Omniverse engine
...
* [ROS Kubernetes / KubeEdge](https://github.com/fujitatomoya/ros_k8s) ⭐ 240 | 🐛 10 | 🌐 HTML | 📅 2026-01-02 - Kuberenetes / ROS\&ROS2 Cluster Samples
...
* [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 7,038 | 🐛 40 | 📅 2024-09-22 (Kiloreux)
