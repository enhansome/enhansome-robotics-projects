...
* [LeRobot](https://github.com/huggingface/lerobot/tree/main) ⭐ 26,847 | 🐛 816 | 🌐 Python | 📅 2026-08-23 - State-of-the-art AI for real-world robotics
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,599 | 🐛 16 | 🌐 Prolog | 📅 2026-08-13 - Open-source 6-wheel rover based on the rovers on Mars
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,510 | 🐛 25 | 🌐 Python | 📅 2026-01-31 - Making a mini version of the BDX droid. <https://discord.gg/UtJZsgfQGe>
* [Stanford Doggo](https://github.com/Nate711/StanfordDoggoProject) ⭐ 2,547 | 🐛 11 | 📅 2024-07-08 - Open-source quadruped robot
* [CHAMP](https://github.com/chvmp/champ) ⭐ 2,303 | 🐛 55 | 🌐 C++ | 📅 2024-07-04 - 𓃡 CHAMP Quadruped Controller ROS Package
* [BCN3D](https://github.com/BCN3D/BCN3D-Moveo) ⭐ 1,938 | 🐛 47 | 🌐 C++ | 📅 2022-03-01 - Open Source 3D Printed Robotic Arm for educational purposes
...
* [BiDexHand](https://github.com/wengmister/BiDexHand) ⭐ 248 | 🐛 2 | 🌐 Python | 📅 2025-11-23 - BiDexHand: Open-Source 16-DoF Biomimetic Dexterous Hand
...
* [copper-project/copper-rs](https://github.com/copper-project/copper-rs) ⭐ 1,462 | 🐛 30 | 🌐 Rust | 📅 2026-08-21 - Robot SDK in Rust (deterministic and high performance)
* [unitreerobotics/unitree\_sdk2](https://github.com/unitreerobotics/unitree_sdk2) ⭐ 1,306 | 🐛 14 | 🌐 C++ | 📅 2026-08-20 - Unitree robot sdk version 2
...
* Anki Cozmo [Python SDK](https://github.com/anki/cozmo-python-sdk) ⭐ 725 | 🐛 15 | 🌐 Python | 📅 2022-11-26, [C# SDK](https://github.com/anki/cozmo-csharp-sdk) ⭐ 18 | 🐛 1 | 🌐 C# | 📅 2018-12-04, and [PyCozmo](https://github.com/zayfod/pycozmo) ⭐ 225 | 🐛 25 | 🌐 Python | 📅 2022-08-03
* [robotemi/sdk](https://github.com/robotemi/sdk) ⭐ 252 | 🐛 143 | 🌐 Kotlin | 📅 2026-08-07 - temi SDK
* [resibots/minitaur\_sdk](https://github.com/resibots/minitaur_sdk) ⭐ 9 | 🐛 0 | 🌐 C++ | 📅 2019-04-12 - Minitaur SDK extension

### Autonomous Driving

* [commaai/openpilot](https://github.com/commaai/openpilot) ⭐ 63,476 | 🐛 132 | 🌐 Python | 📅 2026-08-23 - openpilot is an open source driver assistance system.
* [ApolloAuto/apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,800 | 🐛 1,045 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform
* [autowarefoundation/autoware.universe](https://github.com/autowarefoundation/autoware.universe) ⭐ 1,736 | 🐛 491 | 🌐 C++ | 📅 2026-08-22 - Open-source software for self-driving vehicles

### ML & Vision

* [openMVG/openMVG](https://github.com/openMVG/openMVG/) ⭐ 6,539 | 🐛 312 | 🌐 C++ | 📅 2025-12-17 - open Multiple View Geometry library. Basis for 3D computer vision and Structure from Motion.
* [borglab/gtsam](https://github.com/borglab/gtsam) ⭐ 3,646 | 🐛 14 | 🌐 Jupyter Notebook | 📅 2026-08-23 - Georgia Tech Smoothing and Mapping Library
* [facebookresearch/theseus](https://github.com/facebookresearch/theseus) ⭐ 2,053 | 🐛 83 | 🌐 Python | 📅 2025-01-16 - A library for differentiable nonlinear optimization
* [CRISP](https://github.com/mjyc/awesome-robotics-projects) ⭐ 1,733 | 🐛 7 | 📅 2026-02-13 - Compliant ROS2 Controllers for Learning-Based Manipulation Policies
* [any4lerobot](https://github.com/Tavish9/any4lerobot) ⭐ 1,137 | 🐛 4 | 🌐 Python | 📅 2026-08-17 - A collection of utilities and tools for LeRobot
...
* [ROSA](https://github.com/nasa-jpl/rosa) ⭐ 1,617 | 🐛 5 | 🌐 Python | 📅 2026-03-17 - The ROS Agent
...
* [web-based visualization libraries](https://github.com/cruise-automation/webviz) ⭐ 2,327 | 🐛 134 | 🌐 JavaScript | 📅 2022-12-17
...
* [URDF-Architect](https://github.com/OpenLegged/URDF-Architect) ⭐ 461 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-18 - URDF-Architect is a web-based visual URDF robot modeler with 3D workspace, structured skeleton/detail/hardware workflows, motor library integration, MuJoCo export, and AI assistance.
...
* [CloudPeek](https://github.com/Geekgineer/CloudPeek/tree/main) ⭐ 124 | 🐛 0 | 🌐 C++ | 📅 2024-10-20 - Lightweight, cross-platform, single-header C++ point cloud viewer
...
* [rosetta — ROS 2 ⇄ LeRobot bridge](https://github.com/iblnkn/rosetta) ⭐ 90 | 🐛 3 | 🌐 Python | 📅 2026-08-05 - Standardizes the interface between ROS 2 topics and LeRobot policies using a small YAML contract
...
* [mujoco-scene-editor](https://github.com/markusgrotz/mujoco-scene-editor) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-04-14 - Lightweight, interactive scene editor for MuJoCo scenes
...
* [Open 3D Engine (O3DE)](https://github.com/o3de/o3de) ⭐ 9,621 | 🐛 3,490 | 🌐 C++ | 📅 2026-08-22 - An Apache 2.0-licensed multi-platform 3D engine that enables developers and content creators to build AAA games, cinema-quality 3D worlds, and high-fidelity simulations without any fees or commercial obligations.
...
* [LIBERO](https://github.com/Lifelong-Robot-Learning/LIBERO) ⭐ 2,223 | 🐛 98 | 🌐 Jupyter Notebook | 📅 2025-03-15 - Benchmarking Knowledge Transfer in Lifelong Robot Learning
* [OmniGibson](https://github.com/StanfordVL/OmniGibson) ⭐ 1,647 | 🐛 308 | 🌐 Python | 📅 2026-08-20 - A platform for accelerating Embodied AI research built upon NVIDIA's Omniverse engine
* [MetaDrive](https://github.com/metadriverse/metadrive/) ⭐ 1,234 | 🐛 102 | 🌐 Python | 📅 2025-08-15 -  Open-source Driving Simulator for AI and Autonomy Research
* [SimplerEnv](https://github.com/simpler-env/SimplerEnv) ⭐ 1,145 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2025-12-20 - Simulated Manipulation Policy Evaluation Environments for Real Robot Setups
* [Project dave](https://github.com/Field-Robotics-Lab/dave/wiki) ⭐ 296 | 🐛 36 | 🌐 C++ | 📅 2024-08-19 - A simulation environment to support the rapid testing and evaluation of underwater robotic solutions
...
* [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 6,976 | 🐛 37 | 📅 2024-09-22 (Kiloreux)
...
* [Awesome Robotics](https://github.com/ahundt/awesome-robotics) ⭐ 1,478 | 🐛 8 | 📅 2024-01-10 (ahundt)
* [Awesome Weekly Robotics](https://github.com/msadowski/awesome-weekly-robotics) ⭐ 1,064 | 🐛 5 | 📅 2026-05-31
