...
* [LeRobot](https://github.com/huggingface/lerobot/tree/main) ⭐ 27,500 | 🐛 890 | 🌐 Python | 📅 2026-09-15 - State-of-the-art AI for real-world robotics
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,648 | 🐛 14 | 🌐 HTML | 📅 2026-09-03 - Open-source 6-wheel rover based on the rovers on Mars
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 4,081 | 🐛 31 | 🌐 Python | 📅 2026-01-31 - Making a mini version of the BDX droid. <https://discord.gg/UtJZsgfQGe>
...
* [copper-project/copper-rs](https://github.com/copper-project/copper-rs) ⭐ 1,491 | 🐛 25 | 🌐 Rust | 📅 2026-09-14 - Robot SDK in Rust (deterministic and high performance)
* [unitreerobotics/unitree\_sdk2](https://github.com/unitreerobotics/unitree_sdk2) ⭐ 1,359 | 🐛 14 | 🌐 C++ | 📅 2026-09-15 - Unitree robot sdk version 2
...
* [commaai/openpilot](https://github.com/commaai/openpilot) ⭐ 63,660 | 🐛 134 | 🌐 Python | 📅 2026-09-15 - openpilot is an open source driver assistance system.
* [ApolloAuto/apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,826 | 🐛 1,047 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform
* [autowarefoundation/autoware.universe](https://github.com/autowarefoundation/autoware.universe) ⭐ 1,755 | 🐛 489 | 🌐 C++ | 📅 2026-09-15 - Open-source software for self-driving vehicles
...
* [borglab/gtsam](https://github.com/borglab/gtsam) ⭐ 3,682 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-09-14 - Georgia Tech Smoothing and Mapping Library
...
* [CRISP](https://github.com/mjyc/awesome-robotics-projects) ⭐ 1,775 | 🐛 10 | 📅 2026-02-13 - Compliant ROS2 Controllers for Learning-Based Manipulation Policies
* [any4lerobot](https://github.com/Tavish9/any4lerobot) ⭐ 1,157 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - A collection of utilities and tools for LeRobot
...
* [ROSA](https://github.com/nasa-jpl/rosa) ⭐ 1,632 | 🐛 4 | 🌐 Python | 📅 2026-03-17 - The ROS Agent
...
* [Open 3D Engine (O3DE)](https://github.com/o3de/o3de) ⭐ 9,686 | 🐛 3,490 | 🌐 C++ | 📅 2026-09-14 - An Apache 2.0-licensed multi-platform 3D engine that enables developers and content creators to build AAA games, cinema-quality 3D worlds, and high-fidelity simulations without any fees or commercial obligations.
* [Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,580 | 🐛 56 | 🌐 C# | 📅 2024-11-26 - Central repository for tools, tutorials, resources, and documentation for robotics simulation in Unity
* [LIBERO](https://github.com/Lifelong-Robot-Learning/LIBERO) ⭐ 2,314 | 🐛 99 | 🌐 Jupyter Notebook | 📅 2025-03-15 - Benchmarking Knowledge Transfer in Lifelong Robot Learning
* [OmniGibson](https://github.com/StanfordVL/OmniGibson) ⭐ 1,699 | 🐛 312 | 🌐 Python | 📅 2026-09-14 - A platform for accelerating Embodied AI research built upon NVIDIA's Omniverse engine
...
* [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 7,140 | 🐛 40 | 📅 2024-09-22 (Kiloreux)
